        ...
        try:
            ...
            if dialogue.status not in ['qualified', 'rejected'] and new_state == 'qualification_complete':
                ...
                verification_prompt = (
                    ...
                    ПРАВИЛА ГРАЖДАНСТВА:
                    1. Если Россия/РФ -> "РФ".
                    2. Если любая другая страна -> Название страны.
                    
                    ПРАВИЛА СУДИМОСТИ:
                    1. "чисто" — если нет судимости или она экономическая.
                    2. "против личности" — если убийство, насилие, разбой, тяжкие телесные.

                    Верни ответ ТОЛЬКО в формате JSON:
                    {
                        "age": <целое число или null>,
                        "citizenship": "<строка>",
                        "has_patent": "<да/нет/не требуется>",
